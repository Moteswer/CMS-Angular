...
class Diagnosis(models.Model):
    ...
    dosage=models.CharField(max_length=150,default='')
    ...
    def __str__(self):
        return f"Diagnosis ID: {self.diagnosis_id}, Doctor: {self.doctor}, Patient: {self.patient}"
...
class Bill(models.Model):
    ...
    def __str__(self):
        return f"Bill for Diagnosis ID: {self.diagnosis_id}"
